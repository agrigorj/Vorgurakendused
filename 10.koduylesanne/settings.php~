...
<body>
    ...
    <form method="POST" action="?">
        ...
        <fieldset>
            ...
            <input type="number" min="0" max="20" step="1" value="<?php echo $border_width;?>" name="bw" id="bw" >
            <label>Piirjoone laius (0-20px)</label>
            <br/>
            <select name="bs">
            <option value="<?php echo $border_style;?>"><?php echo $border_style; ?></option>
